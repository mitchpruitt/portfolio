...
<ProjectSection sectionTitle="Process">
    ...
    <Fragment slot="gallery">
        ...
        <GalleryImage image={researchUI} group="B" caption="Years of watching sci-fi movies like Alien, Minority Report, and Iron Man (pictured) had given me an appreciation for UI long before I ever considered it a career option."/>
        ...
        <GalleryImage image={oneColor} group="B" caption="I exported finished SketchUp model as a .dwg file, which I could then import to illustrator for final editing." />
    </Fragment>
</ProjectSection>
