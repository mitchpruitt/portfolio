...
<EmbedSection sectionTitle="Prototype">
    <Fragment slot="embed">
        <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="100%" height="100%" src="https://embed.figma.com/proto/DjMBA9iGTVtHtn8MMxtPDp/API-Editor-Prototype?page-id=0%3A1&node-id=32-487&node-type=frame&viewport=613%2C445%2C0.5&scaling=min-zoom&content-scaling=min-zoom&starting-point-node-id=32%3A487&embed-host=share" allowfullscreen></iframe>
    </Fragment>
    <Fragment slot="text">
        ...
        - The detail panel also contained other tabbed views to aide in developing a request: a list of variables present in the body, other Feature files that utilize this particular request, and a place to offer dummy values for a one-off test.
...
<ProjectSection sectionTitle="Outcome">
    ...
    <Fragment slot="gallery">
       <GalleryVideo url={tour} thumb={tourThumb} group="C" caption="A quick tour of the API Editor interface captured during development." />
