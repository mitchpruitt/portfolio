...
<ProjectSection sectionTitle="Concept">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={durhamBulls} group="A" caption="The Cycle Labs team assembled to watch the Durham Bulls play a game in early 2022." />
        <GalleryItem image={drinkTicket} group="A" caption="CyCool was our unoffical company mascot, frequently appearing in internal collateral like these drink tickets I illustrated." />
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle="Process">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={sketch1} group="B" caption="Early sketches featuring some baseball-styled elements." />
        <GalleryItem image={sketch2} group="B" caption="Rough attempts at car badges and corporate elements, like a challenge coin and the testing triangle." />
        <GalleryItem image={baseballStyle} group="B" caption="Preliminary vectors for the baseball-inspired logo." />
        <GalleryItem image={carBadge} group="B" vertical="true" caption="Vector tests for the car badge concept." />
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle="Outcome">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={shirtFinal} group="C" vertical="true" caption="The finished work." />
