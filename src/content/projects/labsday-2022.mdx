...
<ProjectSection sectionTitle="Concept">
    <Fragment slot="text">
        ...
        Once the hard requirements had been set, I started thinking about the company, what it meant to me, and what we had experienced over the last year. Start-ups, like children, grow and change quickly. They develop their own culture, habits, activities, and ways of thinking. I used this framework to rough out some early sketches for the project.
    </Fragment>

    <Fragment slot="gallery">
        <GalleryItem image={durhamBulls} caption="The Cycle Labs team assembled to watch the Durham Bulls play a game in early 2022." />
        <GalleryItem image={drinkTicket} caption="CyCool was our unoffical company mascot, frequently appearing in internal collateral like these drink tickets I illustrated." />
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle="Process">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={sketch1} caption="Early sketches featuring some baseball-styled elements." />
        <GalleryItem image={sketch2} caption="Rough attempts at car badges and corporate elements, like a challenge coin and the testing triangle." />
        <GalleryItem image={baseballStyle} caption="Preliminary vectors for the baseball-inspired logo." />
        <GalleryItem image={carBadge} vertical="true" caption="Vector tests for the car badge concept." />
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle="Outcome">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={shirtFinal} vertical="true" caption="The finished work." />
