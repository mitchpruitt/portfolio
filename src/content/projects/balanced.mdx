...
<ProjectSection sectionTitle="Concept">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={logo} group="A" caption="Cycle Labs' logo and wordmark." />
        <GalleryItem image={meeting} group="A" caption="The organization met once or twice a year for all-hands presentations." />
        <GalleryItem image={karting} group="A" vertical={"true"} caption="Ripping it up at Rush Hour Karting after business had concluded." />
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle="Process">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={sketch1} group="B" vertical={"true"} caption="Early sketch work demonstrating the pancake and button concepts." />
        <GalleryItem image={sketch2} group="B" vertical={"true"} caption="More early sketches, including the FX pedal." />
        <GalleryItem image={sketch3} group="B" vertical={"true"} caption="Another attempt at an FX pedal, this time incorporating themes like 'supercharging' and 'amplifying'." />
        <GalleryItem image={sketchrefined} group="B" caption="Second and third iterations of my pancake illustration. I spend so much time on the computer that I enjoy drawing by hand whenever possible." />
        <GalleryItem image={pedalvector} group="B" vertical={"true"} caption="In-progress art for the pedal concept." />        
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle="Outcome">
    ...
    <Fragment slot="gallery">
        <GalleryItem image={pancakefinal} group="C" vertical={"true"} caption="The final shirt graphic." />
        <GalleryItem image={model} group="C" vertical={"true"} caption="A model showcasing my design." />
    </Fragment>
</ProjectSection>