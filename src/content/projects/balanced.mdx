...
<ProjectSection sectionTitle="Concept">
    ...
    <Fragment slot="gallery">
        ...
        <GalleryImage image={meeting} group="A" caption="The organization met once or twice a year for all-hands presentations." />
        <GalleryImage image={karting} group="A" vertical={"true"} caption="Ripping it up at Rush Hour Karting after business had concluded." />
    </Fragment>
</ProjectSection>
