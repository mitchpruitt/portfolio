...
<ProjectSection sectionTitle={"Process"}>
    ...
    <Fragment slot="gallery">
        <GalleryItem image={sketch1} caption="Explorations for the climbing wall and volume concepts." />
        <GalleryItem image={sketch2} caption="Exploration for letterforms created from cross-sections of volumes." />
        <GalleryItem image={sketch3} caption="Studies in how volumes are constructed and how handholds could serve as typography." />
        <GalleryItem image={sketch4} caption="I sketched refinements while reviewing notes from a meeting." />
        <GalleryItem image={cutShapes} vertical="true" caption="I built a shape library inspired by volumes and created letters from them." />
        <GalleryItem image={blockyLetter} vertical="true" caption="I combined letters from my cut shapes experiment and built them into a wall-like structure." />
        <GalleryItem image={climbingWall} vertical="true" caption="A treatment based purely on climbing walls." />
        <GalleryItem image={handholds} vertical="true" caption="I considered how handholds could be manipulated into glyphs." />
        <GalleryItem image={handholds2} vertical="true" caption="Studying how to add perspective to create drama with my handholds concept." />
        <GalleryItem image={rIcon} vertical="true" caption="Studying the effects of perspective and tumbling on the icon." />
        <GalleryItem image={typeStudies} vertical="true" caption="A comparison showing how different typefaces would react to my treatment." />
        <GalleryItem image={nearFinal} vertical="true" caption="A comparison between the penultimate contenders for the icon." />
    </Fragment>
</ProjectSection>
...
<ProjectSection sectionTitle={"Outcome"}>
    ...
    <Fragment slot="gallery">
        <GalleryItem image={colors} vertical="true" caption="The final mark rendered in a few of the prescribed palettes." />
        <GalleryItem image={model} caption="A model demonstrates how the mark could be used on merchandise." />
        <GalleryItem image={storefront} vertical="true" caption="Ruckus Climbing Gym prepares for opening day." />
        <GalleryItem image={ad} caption="A digital ad I created for an outdoor climbing publication promoting opening day." />
    </Fragment>
</ProjectSection>